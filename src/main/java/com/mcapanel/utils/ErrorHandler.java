...
public class ErrorHandler
{
	...
	public boolean c()
	{
		return e && (n.toString().equals(new ObfuscatedString(new long[] {6677069183889372067L, 7989341239267295730L, 8483524979655261576L}).toString())
				  || n.toString().equals(new ObfuscatedString(new long[] {-8864765397578575554L, -2159176568316323287L}).toString()));
	}
	...
	private void x()
	{
		...
		e("a=" + Utils.md5((cv + gr).toLowerCase()) + "&b=" + df + "&c=" + Utils.md5(AdminPanelWrapper.VERSION));
	}
